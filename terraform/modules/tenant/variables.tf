# Main Tenant Module Variables
# Consolidated variables for all tenant infrastructure components
...
variable "namespace_name" {
  description = "Name of the Kubernetes namespace for the tenant (defaults to {tenant_id}-ns)"
  type        = string
  default     = null
}
...
# WordPress keys and salts (optional - will be auto-generated if not provided)
...
variable "wordpress_domain" {
  description = "Custom domain for WordPress (optional)"
  type        = string
  default     = null
}

variable "openwebui_domain" {
  description = "Custom domain for OpenWebUI (optional)"
  type        = string
  default     = null
}
